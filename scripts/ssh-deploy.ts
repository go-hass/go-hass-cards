...
child_process.execSync(`scp ./dist/go-hass-cards.js ${process.env.SSH_USER}@${process.env.SSH_HOST}:${process.env.SSH_HA_PATH}/config/www/`);
...
const auth = createLongLivedTokenAuth(
    `http://${process.env.SSH_HOST}:8123`,
