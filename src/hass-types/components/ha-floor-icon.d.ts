...
export declare const floorDefaultIcon: (floor: Pick<FloorRegistryEntry, "level">) => "mdi:home" | "mdi:home-floor-0" | "mdi:home-floor-1" | "mdi:home-floor-2" | "mdi:home-floor-3" | "mdi:home-floor-negative-1";
