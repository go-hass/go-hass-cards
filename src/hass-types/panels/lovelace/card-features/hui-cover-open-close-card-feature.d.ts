...
import type { CoverOpenCloseCardFeatureConfig, LovelaceCardFeatureContext } from "./types";
export declare const supportsCoverOpenCloseCardFeature: (hass: HomeAssistant, context: LovelaceCardFeatureContext) => boolean;
